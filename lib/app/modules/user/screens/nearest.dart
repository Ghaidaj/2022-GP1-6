          ...
          child: Column(
            children: [
              ...
              buildCard(
                () => Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => PlaceView(title: "Hospitals",placeType: PlaceTypes.hospital)),
                ),
                'hospitals',
                'Hospitals',
              ),
              ...
              buildCard(
                () => Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => PlaceView(title: "Pharmacies",placeType: PlaceTypes.pharmacy)),
                ),
                'pharmacies',
                'Pharmacies',
              ),
              ...
              buildCard(
                () => Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => PlaceView(title: "Police Stations",placeType: PlaceTypes.police)),
                ),
                'policestations',
                'Police Stations',
              ),
